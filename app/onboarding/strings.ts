...
export const ONBOARDING_STRINGS: Record<Language, OnboardingStrings> = {
  en: {
    ...
    ui: {
      ...
      trustCopy: "AidPilot is an organizational and educational tool, not official financial aid advice. We never ask you to type FAFSA logins or SSNs; vault uploads are optional.",
  ...
  es: {
    ...
    ui: {
      ...
      trustCopy: "AidPilot es una herramienta organizativa y educativa, no asesoría oficial de ayuda financiera. Nunca te pedimos escribir contraseñas de FAFSA ni SSN; las subidas a la bóveda son opcionales.",
      languageEnglish: "English",
      languageEnglishSub: "Continue in English",
      languageSpanish: "Español",
      languageSpanishSub: "Continuar en español",

  ...
  return (
    ...
    >
      ...
      <SectionCard title="Overview">
        ...
        <p style={{ marginTop: 12 }}>AidPilot is an independent service. We are <strong style={{ color: "var(--text-heading)" }}>not FAFSA</strong>, not Federal Student Aid, not the U.S. Department of Education, and <strong style={{ color: "var(--text-heading)" }}>not affiliated with any college, university, or scholarship provider</strong>.</p>
      ...
      <SectionCard title="Your choices and control">
        <p><strong style={{ color: "var(--text-heading)" }}>You control your profile data.</strong> You can update your profile and preferences in Settings at any time.</p>
        <p style={{ marginTop: 12 }}>You may request access to, correction of, or deletion of your account and data. Use the &quot;Request account deletion&quot; option in Settings, or email us at{" "}
          <a href="mailto:privacy@aidpilot.app" style={linkStyle}>privacy@aidpilot.app</a>.
        </p>

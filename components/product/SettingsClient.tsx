...
const SETTINGS_STRINGS: Record<Language, {
  ...
  en: {
    ...
    privacySub: "Your data stays yours. We never ask you to type FAFSA logins or SSNs; vault files are stored only if you upload them.",
  ...
  es: {
    ...
    privacySub: "Tus datos son tuyos. Nunca te pedimos escribir credenciales de FAFSA ni SSN; los archivos de la bóveda solo se guardan si los subes.",

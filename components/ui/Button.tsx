...
export function Button({
  ...
  if (clay) {
    ...
    bg = isDisabled ? "#e5e7eb" : hover ? "#094b8e" : "#0b5cad";
    color = isDisabled ? "#9aa4b2" : "#fff";
    border = "none";
  ...
  return (
    <button
      ...
      className={`ap-btn${className ? ` ${className}` : ""}`}
      style={{
        display: "inline-flex",
        alignItems: "center",
        ...
        transition: "background-color .15s ease, background-image .15s ease, box-shadow .2s ease, transform .1s ease",
        whiteSpace: "nowrap",

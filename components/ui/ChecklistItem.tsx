  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <span style={{ fontSize: 14.5, fontWeight: 600, color: done ? "var(--gray-400)" : "var(--ink-800)", textDecorationLine: done ? "line-through" : "none", textDecorationColor: "var(--gray-300)" }}>
          {title}
        </span>

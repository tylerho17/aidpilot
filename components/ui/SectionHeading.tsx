...
const EYEBROW_COLORS: Record<SectionHeadingEyebrowTone, string> = {
  blue: "var(--blue-700)",
  green: "var(--green-600)",
  amber: "var(--amber-600)",
  coral: "var(--coral-600)",
...
const TITLE_SIZES: Record<SectionHeadingSize, number> = { sm: 24, md: 30, lg: 42 };

type SectionHeadingEyebrowTone = "blue" | "green" | "amber" | "coral";
type SectionHeadingAlign = "left" | "center";
type SectionHeadingSize = "sm" | "md" | "lg";

export type SectionHeadingProps = {
  eyebrow?: ReactNode;
  eyebrowTone?: SectionHeadingEyebrowTone;
  title?: ReactNode;
  subtitle?: ReactNode;
  action?: ReactNode;

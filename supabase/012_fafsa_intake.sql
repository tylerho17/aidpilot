...
create table if not exists public.fafsa_intake_responses (
  ...
  fafsa_progress text not null default 'not_started',
  has_student_aid_account text not null default 'not_sure',
  contributor_required text not null default 'not_sure',
  parent_has_student_aid_account text,
  has_tax_info text not null default 'not_sure',
  has_school_portal_access text not null default 'not_sure',
  has_aid_offer text not null default 'no',
  has_verification_request text not null default 'not_sure',

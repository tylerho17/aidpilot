...
export function makeDemoOffers(): UserAidOffer[] {
  return [
    ...
    {
      id: `${DEMO_ID_PREFIX}offer-berkeley`,
      user_id: DEMO_USER_ID,
      school_name: "UC Berkeley",
      offer_status: "official",
      academic_year: "2026–27",
      cost_of_attendance: 45500,
      tuition_and_fees: 15800,
      housing_and_food: 22400,
      books_and_supplies: 1400,
      transportation: 2100,
      personal_expenses: 3800,
      grants_and_scholarships: 26000,
      work_study: 2500,
      federal_student_loans: 5500,
      parent_plus_loans: 0,
      private_loans: 0,
      other_aid: 0,
      renewal_notes: "Cal Grant renews with the FAFSA/CADAA and GPA verification.",
      notes: null,
      created_at: timestampDaysAgo(9),
      updated_at: timestampDaysAgo(2),
    },
    {
      id: `${DEMO_ID_PREFIX}offer-fresno`,
      user_id: DEMO_USER_ID,
      school_name: "Fresno State",
      offer_status: "official",
      academic_year: "2026–27",
      cost_of_attendance: 27200,
      tuition_and_fees: 6600,
      housing_and_food: 15400,
      books_and_supplies: 1100,
      transportation: 2300,
      personal_expenses: 1800,
      grants_and_scholarships: 22800,
      work_study: 2000,
      federal_student_loans: 3500,
      parent_plus_loans: 0,
      private_loans: 0,
      other_aid: 0,
      renewal_notes: "Cal Grant + State University Grant; refile the FAFSA/CADAA each year.",
      notes: null,
      created_at: timestampDaysAgo(7),
